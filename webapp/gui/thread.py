...
"""
doc: https://stackoverflow.com/a/62722241/2402577
check for threads under https://github.com/PySimpleGUI/PySimpleGUI/tree/master/DemoPrograms
"""
...
def run_me():
    ...
    return f"*** The thread says.... *** {Ebb.get_deployed_block_number()}"
