...
contractCallPath = lib.EBLOCPATH + '/contractCalls'  os.environ['contractCallPath'] = contractCallPath 
...
with open(fname, "r") as ins:
	...
	sum1 += (int(res[7]) - int(res[8]))
        ...
        print(str(counter) + " " + res[1] + " " + res[2] + " " + res[3] + " | " + lib.job_state_code[r[0]] + "," + r[1] + "," + r[2] + "," + r[3] + "," + r[4] + "," + r[5]) 
        counter += 1 
