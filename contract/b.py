...
def test_submitJob_gas():
    ...
    _execution_time_min = [execution_time_min]
    args = [index, jobID, completionTime, dataTransferIn, dataTransferOut, job.cores, _execution_time_min, True]
    ...
    print(config.Ebb.getJobInfo(provider, job.key, index, jobID))
    ...
    # print("received_gas_used=" + str(gas_base))
    # job = Job()
    # job.source_code_hashes = [b"8b3e98abb65d0c1aceea8d606fc55403"]
    ...
    # jobID = 0
    # startTime = 36
    # tx = config.Ebb.setJobStatusRunning(job.source_code_hashes[0], job.index, jobID, startTime, {"from": accounts[0]})
    # rpc.sleep(60)
    # mine(5)
    # completionTime = 51
    # dataTransferIn = 0
    ...
    # execution_time_min = 1
    # _execution_time_min = [execution_time_min]
    # args = [job.index, jobID, completionTime, dataTransferIn, dataTransferOut, job.cores, _execution_time_min, True]

    # tx = config.Ebb.processPayment(job.source_code_hashes[0], args, execution_time_min, "", {"from": accounts[0]})
    ...
    # print("----------------------------------")
    # print("each_iteration=" + str(gas_end - gas_base))
    # print("DONE")
