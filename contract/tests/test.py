...
def receiptCheck(my_contract, chain, e, ipfsHash, index, timeToRun):
    usedBandwidth    = 200
    set_txn_hash     = my_contract.transact().receiptCheck(ipfsHash, index, timeToRun, "QmWmyoMoctfbAaiEs2G46gpeUmhqFRDW6KWo64y5r581Ve", 0, e, usedBandwidth)
...
def test_receipt(web3, accounts, chain): #{
    ...
    set_txn_hash     = my_contract.transact().registerCluster(1, "cluster@gmail.com", "ee14ea28-b869-1036-8080-9dbd8c6b1579@b2drop.eudat.eu", "9VZyJy1gRFJfdDtAjRitqmjSxPjSAjBR6BxH59UeNgKzQ", coreMinPrice, memoryMinPrice, "/ip4/79.123.177.145/tcp/4001/ipfs/QmWmZQnb8xh3gHf9ZFmVQC4mLEav3Uht5kHJxZtixG3rsf", whisperPubKey)
    contract_address = chain.wait.for_receipt(set_txn_hash)
    ...
    web3.eth.defaultAccount = accounts[0]
    set_txn_hash     = my_contract.transact().registerCluster(128, "cluster@gmail.com", "ee14ea28-b869-1036-8080-9dbd8c6b1579@b2drop.eudat.eu", "9VZyJy1gRFJfdDtAjRitqmjSxPjSAjBR6BxH59UeNgKzQ", coreMinPrice, memoryMinPrice, "0x", whisperPubKey)
    ...
    with open(fname) as f: 
        for line in f:
            ...
            set_txn_hash = my_contract.transact({"from": accounts[8],
                                                 "value":web3.toWei(60 * 10000000000000000 * coreNum, "wei"
