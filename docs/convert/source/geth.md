...
- If something went wrong during building from source, install `go-ethereum` using Homebrew tap.
...
If something went wrong during building from source install `go-ethereum` from PPA.
