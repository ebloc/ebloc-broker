...
def convert_bytes32_ipfs(bytes_array):
...
def ipfs_chech(greeter, chain, web3):
    ...
    hex_str = convert_ipfs_bytes32(ipfsHash)  # "7d5a99f603f231d53a4f39d1521f98d2e8bb279cf29bebfd0687dc98458e7f89";
    ...
    ipfsHashRet = convert_bytes32_ipfs(ret)
    assert ipfsHash == ipfsHashRet


def combine_uint128(variable1, variable2):
