...
from contractCalls.registerRequester import registerRequester
...
for i in range(0, accoutLength):
    ...
    tx = registerRequester(accountID, email, federationCloudID, miniLockID, ipfsAddress, githubUsername, eBlocBroker, web3)
