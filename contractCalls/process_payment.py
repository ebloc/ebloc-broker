...
def process_payment(
    ...
    logging.info(
        f"~/eBlocBroker/contractCalls/process_payment.py {job_key} {index} {job_id} {execution_time_min}"
        f" {result_ipfs_hash} {cloud_storage_id} {end_time} {dataTransferIn} {dataTransferOut} '{core}'"
        f" '{executionDuration}'"
    )
