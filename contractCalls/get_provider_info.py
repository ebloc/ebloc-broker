...
def get_provider_info(_provider, eBlocBroker=None, w3=None):
    ...
    provider_info = {'blockReadFrom':     blockReadFrom,
...
if __name__ == '__main__':
    ...
    if status:
        print('{0: <20}'.format('blockReadFrom: ')      + str(provider_info['blockReadFrom'])      + '\n' +
              '{0: <20}'.format('availableCoreNum: ')   + str(provider_info['availableCoreNum'])   + '\n' +
              '{0: <20}'.format('priceCoreMin: ')       + str(provider_info['priceCoreMin'])       + '\n' +
              '{0: <20}'.format('priceDataTransfer: ')  + str(provider_info['priceDataTransfer'])  + '\n' +
              '{0: <20}'.format('priceStorage: ')       + str(provider_info['priceStorage'])       + '\n' +
              '{0: <20}'.format('priceCache: ')         + str(provider_info['priceCache'])         + '\n' +               
              '{0: <20}'.format('commitmentBlockNum: ') + str(provider_info['commitmentBlockNum']) + '\n' +              
              '{0: <20}'.format('email: ')              + provider_info['email']                   + '\n' +  
              '{0: <20}'.format('miniLockID: ')         + provider_info['miniLockID']              + '\n' +
              '{0: <20}'.format('ipfsID: ')             + provider_info['ipfsID']                  + '\n' +
              '{0: <20}'.format('fID: ')                + provider_info['fID']                     + '\n' +
              '{0: <20}'.format('whisperID: ')          + provider_info['whisperID'])
