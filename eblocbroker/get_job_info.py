...
def update_job_cores(self, job_info, provider, job_key, index, job_id, received_block_number=None):
...
def get_job_source_code_hashes(self, job_info, provider, job_key, index, job_id, received_block_number=None):
