...
from lib import _try, compress_folder, log, run, silent_remove
...
def mlck_encrypt(provider_minilock_id, mlck_pass, target):
    ...
    try:
        ...
        return True, f"{target_compressed}.minilock"
    except:
        return False, f"{target_compressed}.minilock"
