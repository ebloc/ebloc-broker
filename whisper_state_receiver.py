...
# To run:
# ./whisper_state_receiver.py 0 # logs into a file
# ./whisper_state_receiver.py 1 # prints into console
...
def log(str_in):
    if test_flag:
        ...
        txFile = open(env.LOG_PATH + "/whisper_state_receiverLog.out", "a")
        txFile.write(f"{str_in}\n")
        txFile.close()
