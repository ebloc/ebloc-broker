...
def eudatSubmitJob(provider, oc, eBlocBroker=None, w3=None): # fc33e7908fdf76f731900e9d8a382984
    ...
    jobPriceValue, _cost = cost(core_list, coreMin_list, provider, requester, sourceCodeHash_list, dataTransferIn_list, dataTransferOut,
                                storageHour_list, storageID_list, cacheType_list, data_prices_set_blocknumber_list, eBlocBroker, w3, False)

    status, result = submitJob(provider, jobKey, core_list, coreMin_list, dataTransferIn_list, dataTransferOut, storageID_list,
                               sourceCodeHash_list, storageID_list, storageHour_list, accountID, jobPriceValue, data_prices_set_blocknumber_list, eBlocBroker, w3)
